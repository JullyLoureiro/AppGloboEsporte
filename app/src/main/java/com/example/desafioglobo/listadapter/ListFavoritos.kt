...
import com.example.desafioglobo.view.favoritos.FavoritosFragment
...
class ListFavoritos(private val context: Activity?,private val artigos: List<Artigos>)
    ...
    fun recarregaTela(context: Activity){
